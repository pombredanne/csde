...
namespace :kcsd do
  ...
  # 1. distribute the Murder supported files from KCSD Server to all nodes in the Murder folder (Seeder/Tracker/Peer)
  ...
  task :prepare_distribution, :roles => [:tracker, :seeder, :peer] do
		...
		# INFO
		puts "::::::::::::::::: KCSD Server will create a Murder folder and distribute the Murder supported files to all nodes. These files are needed for the distribution via BitTorrent"
		puts "::::::::::::::::: The Murder directory is: #{murder_path}"
		puts "::::::::::::::::: KCSD Server will create a Distribution folder in all nodes. This folder will contain the distributed files"
    ...
    # the supported folder which will be distributed to all nodes
		# this folder is located in KCSD Server
    ...
    # if the Murder supported folder does NOT exist then create a new murder folder
		...
		# tar the dist folder
		puts "::::::::::::::::: Taring the dist folder in KCSD Server"
  ...
  task :create_torrent_in_the_seeder, :roles => :seeder do
    ...
    # create the .torrent file in the seeder, the .torrent is saved in #{temp_path}
		...
		# get the torrent file from the Seeder to KCSD Server
		puts "::::::::::::::::: Downloading the new .torrent file to KCSD Server"
  ...
  task :start_peering, :roles => :peer do
    # CHECK
		...
		# get the .torrent file from KCSD Server
		puts "::::::::::::::::: Transfering the .torrent file from KCSD Server to all Peers "
  ...
  # ============================================================================================================= 
    ...
    # CHECK
		...
		run "sudo rm -rf #{temp_path}/* || exit 0"
  
		puts "::::::::::::::::: Cleaning up temp files in KCSD Server"
		system "sudo rm -rf #{temp_path}/* || exit 0"
	end
