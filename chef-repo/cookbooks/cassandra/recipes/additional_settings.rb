...
execute 'echo "export JAVA_HOME=/usr/lib/jvm/java-1.6.0-openjdk-amd64" | sudo -E tee -a ~/.bashrc'
execute 'echo "export JAVA_HOME=/usr/lib/jvm/java-1.6.0-openjdk-amd64" | sudo -E tee -a ~/.profile'
