...
class DashboardController < ApplicationController
  ...
  def show
    ...
    @status << "Click on tab <strong>Credentials</strong> to input your <strong>Cloud Credentials</strong>\n"
...
#     
    ...
    # ec2.servers.each do |server|
      # # show all the instances that CSDE manages
...
# 
    # logger.debug "::: Deleting monitoring folder in CSDE Server..."
    # if File.exist? "#{ENV['HOME']}/opscenter"
      # File.delete "#{ENV['HOME']}/opscenter"
    # end
    # logger.debug "::: Deleting monitoring folder in CSDE Server... [OK]"
#     
