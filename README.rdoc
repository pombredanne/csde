...
KCSDB now can be installed on Ubuntu 11.10 x64 and 12.04 x64. Please use the EBS AMIs of Canonical in AWS EC2
For example
Region: US-EAST-1
...
* Download and execute install_ruby_via_rvm.sh script to install ruby 1.9.3
 $ curl --location https://raw.github.com/lehoanganh/kcsdb/master/install_ruby_via_rvm.sh --silent | bash
* Load rvm into shell
 $ . $HOME/.bashrc
* Set ruby 1.9.3 as default
 $ rvm --default use 1.9.3
* Install KCSDB
 $ curl --location https://raw.github.com/lehoanganh/kcsdb/master/install_kcsdb.sh --silent | rvmsudo bash
 # Always accept 'yes's by installing Gmetad
...
Thus, use another way to install Sun JDK
 $ curl --location https://github.com/flexiondotorg/oab-java6/raw/0.2.4/oab-java.sh --silent | sudo bash
