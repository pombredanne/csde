...
* Lauch a virtual machine
* Download the install_ruby_via_rvm.sh script to install ruby
 $ wget https://raw.github.com/lehoanganh/kcsdb/master/install_ruby_via_rvm.sh
* Make the script executable
 $ chmod +x install_ruby_via_rvm.sh
* Execution
 $ ./install_ruby_via_rvm.sh
