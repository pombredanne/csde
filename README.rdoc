...
* Install needed softwares for before install CSDE server
Amazon EC2
 $ curl -L https://raw.github.com/lehoanganh/kcsdb/master/prepare_machine_for_csde_rhel_6.sh -s | bash
IBM SCE
 $ curl -L https://raw.github.com/lehoanganh/kcsdb/master/prepare_machine_for_csde_ubuntu_12.04.sh -s | bash
* Load rvm into shell
 $ source $HOME/.bashrc
* Set ruby 1.9.3 as default
 $ rvm --default use 1.9.3
* Install CSDE
 $ curl -L https://raw.github.com/lehoanganh/kcsdb/master/install_csde.sh -s | rvmsudo bash
