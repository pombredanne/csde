...
* Install KCSDB
 $ curl -L https://raw.github.com/lehoanganh/kcsdb/master/install_kcsdb.sh | rvmsudo bash
...
Thus, use another way to install Sun JDK
 $ curl -L https://github.com/flexiondotorg/oab-java6/raw/0.2.4/oab-java.sh | sudo bash
