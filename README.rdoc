...
* Download and execute install_ruby_via_rvm.sh script to install ruby 1.9.3
 $ curl -L https://raw.github.com/lehoanganh/kcsdb/master/install_ruby_via_rvm.sh | bash
* Load rvm into shell
 $ . $HOME/.bashrc
* Set ruby 1.9.3 as default
 $ rvm --default use 1.9.3
* Load KCSDB script
 $ wget https://raw.github.com/lehoanganh/kcsdb/master/install_kcsdb.sh
* Set execution permisson
 $ chmod +x install_kcsdb.sh
* Execution with root right
 $ rvmsudo bash install_kcsdb.sh
